...
def main():
    ...
    split_datasets = full_ds.train_test_split(test_size=0.15, seed=42)
    ...
    for rf in rfs_to_train:
        ...
        adapter_config_instance = adapters.ParBnConfig(mh_adapter=True, output_adapter=False, reduction_factor=rf)
